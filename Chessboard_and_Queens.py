...
def solve():
    ...
    def canPlace(i,j):
        for ii in range(8):
            ...
            if s[i][ii]=='#':
                return False
            if ii+i<8 and ii+j<8 and s[i+ii][j+ii]=='#':
                return False
            if ii+i<8 and j-ii>=0 and s[i+ii][j-ii]=='#':
                return False
            if i-ii>=0 and ii+j<8 and s[i-ii][j+ii]=='#':
                return False
            if i-ii>=0 and j-ii>=0 and s[i-ii][j-ii]=='#':
                return False
        return True

...
# def lt(self, x: T) -> Optional[T]: "Find the largest element < x, or None if it doesn't exist."
# def le(self, x: T) -> Optional[T]: "Find the largest element <= x, or None if it doesn't exist."
# def gt(self, x: T) -> Optional[T]: "Find the smallest element > x, or None if it doesn't exist."
# def ge(self, x: T) -> Optional[T]: "Find the smallest element >= x, or None if it doesn't exist." 


def solve():
    n,k = lst()
    a = SortedSet(range(1, n + 1))
    p = 0
    res= []
    while len(a)>1:
        p+=k
